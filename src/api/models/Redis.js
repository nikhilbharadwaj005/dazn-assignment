...
// REMOVE the key
const redisREMOVEKey = async (key) => await redisClient.del(key)

export const REDIS = { redisGET, redisSET, redisSETWithExpiry, redisSETWithExistsAndExpiry, redisREMOVEKey }
